DO $$ BEGIN
 CREATE TYPE "public"."personalization_source" AS ENUM('training_history', 'manual_profile', 'none');
EXCEPTION
...
CREATE TABLE IF NOT EXISTS "user_strength_profiles" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "user_strength_profiles_user_id_unique" UNIQUE("user_id")
);
--> statement-breakpoint
ALTER TABLE "workout_programs" ALTER COLUMN "duration_weeks" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "subscription_tier" "subscription_tier" DEFAULT 'free';--> statement-breakpoint
